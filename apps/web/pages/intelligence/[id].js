      ...
      <section className="card">
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', flexWrap:'wrap', gap:'1rem' }}>
          ...
          <div style={{ display:'flex', gap:'0.5rem', flexWrap:'wrap' }}>
            <a href={`${API}/intelligence/${id}/pdf-premium`} target="_blank" rel="noopener noreferrer" title="Premium Intelligence Report (Institutional Quality)" style={{ background:'linear-gradient(135deg,#c9a227,#b8860b)', border:'1px solid #d4a843', borderRadius:8, color:'#1a1a2e', fontSize:'0.82rem', fontWeight:800, padding:'0.4rem 1.2rem', textDecoration:'none', boxShadow:'0 2px 8px rgba(201,162,39,0.3)' }}>★ Premium Report</a>
            <a href={`${API}/intelligence/${id}/pdf-beautiful`} target="_blank" rel="noopener noreferrer" title="Beautifully styled PDF (WeasyPrint)" style={{ background:'linear-gradient(135deg,#6366f1,#4f46e5)', border:'1px solid #818cf8', borderRadius:8, color:'#fff', fontSize:'0.82rem', fontWeight:700, padding:'0.4rem 1rem', textDecoration:'none' }}>Beautiful PDF</a>
            ...
            <a href={`${API}/intelligence/${id}/pdf`} target="_blank" rel="noopener noreferrer" style={{ background:'rgba(129,140,248,0.1)', border:'1px solid var(--line)', borderRadius:8, color:'#c7d2fe', fontSize:'0.82rem', padding:'0.4rem 1rem', textDecoration:'none' }}>PDF</a>
            ...
            <a href={`${API}/intelligence/${id}/excel-detailed`} target="_blank" rel="noopener noreferrer" title="Multi-sheet Excel workbook" style={{ background:'rgba(129,140,248,0.1)', border:'1px solid var(--line)', borderRadius:8, color:'#c7d2fe', fontSize:'0.82rem', padding:'0.4rem 1rem', textDecoration:'none' }}>Excel</a>
            <a href={`${API}/intelligence/${id}/powerpoint-detailed`} target="_blank" rel="noopener noreferrer" title="Data-rich PowerPoint deck" style={{ background:'rgba(129,140,248,0.1)', border:'1px solid var(--line)', borderRadius:8, color:'#c7d2fe', fontSize:'0.82rem', padding:'0.4rem 1rem', textDecoration:'none' }}>PPT</a>
            <a href={`${API}/intelligence/${id}/markdown`} target="_blank" rel="noopener noreferrer" title="Raw markdown source" style={{ background:'rgba(129,140,248,0.1)', border:'1px solid var(--line)', borderRadius:8, color:'#c7d2fe', fontSize:'0.82rem', padding:'0.4rem 1rem', textDecoration:'none' }}>MD</a>
